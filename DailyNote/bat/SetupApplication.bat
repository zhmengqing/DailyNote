...
:: Android packaging
set AND_CERT_NAME="DailyNote"
set AND_CERT_PASS=fd
set AND_CERT_FILE=cert\DailyNote.p12
...
set IOS_PROVISION=cert\DailyNote.mobileprovision
...
set APP_ID=air.DailyNote

:: Output packages
set DIST_PATH=dist
set DIST_NAME=DailyNote
